...
(function () {
  ...
  const dict = {
    en: {
      ...
      "updates.desc": "Bits of recent life and work — short and casual.",
      "updates.descHome": "Latest updates. Open a card for links and details.",
      "updates.viewAll": "View all updates",
      "updates.readMore": "Open →",
      ...
      "updates.backList": "← All updates",
      "updates.missingSlug": "No update selected.",
      "updates.notFound": "Update not found.",
    ...
    zh: {
      ...
      "updates.label": "近况",
      "updates.title": "动态",
      "updates.desc": "个人活动与近况，短短记一笔。",
      "updates.descHome": "最新动态。点开看链接与细节。",
      ...
      "updates.backList": "← 全部动态",
      "updates.missingSlug": "未选择动态。",
      "updates.notFound": "未找到该动态。",
    ...
    "zh-Hant": {
      ...
      "updates.label": "近況",
      "updates.title": "動態",
      "updates.desc": "個人活動與近況，短短記一筆。",
      "updates.descHome": "最新動態。點開看連結與細節。",
      "updates.viewAll": "查看全部",
      "updates.readMore": "查看 →",
      "updates.empty": "暫無動態。",
      "updates.loading": "加載中…",
      ...
      "updates.backList": "← 全部動態",
      "updates.missingSlug": "未選擇動態。",
      "updates.notFound": "未找到該動態。",
    ...
    ja: {
      ...
      "updates.label": "近況",
      "updates.title": "近況",
      "updates.desc": "最近の活動を短くメモ。",
      "updates.descHome": "最新の近況。カードを開くとリンクや詳細を見られます。",
      "updates.viewAll": "すべて見る",
      "updates.readMore": "開く →",
      ...
      "updates.backList": "← すべての近況",
      "updates.missingSlug": "近況が選択されていません。",
      "updates.notFound": "近況が見つかりません。",
